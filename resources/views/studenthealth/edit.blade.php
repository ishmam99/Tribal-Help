...
<script >
    document.getElementById("class_roll").oninput = function() {
         var up = document.getElementById("upazila_name").value; 
         var sch = document.getElementById("school_id"); 
         var school =sch.options[sch.selectedIndex].text;
         var ses = document.getElementById("session").value; 
         var roll = document.getElementById("class_roll").value;
         if(up!=""&&sch!=""&&roll!=""&&ses!="")
        document.getElementById("auto_id").value = ses+up[0]+school[0]+roll; 
        };
        document.getElementById("upazila_name").onchange = function() {
         var up = document.getElementById("upazila_name").value; 
         var sch = document.getElementById("school_id"); 
         var school =sch.options[sch.selectedIndex].text;
         var ses = document.getElementById("session").value; 
        ...
        document.getElementById("auto_id").value = ses+up[0]+school[0]+roll;  
         ...
         document.getElementById("school_id").onchange = function() {
         var up = document.getElementById("upazila_name").value; 
         var sch = document.getElementById("school_id"); 
         var school =sch.options[sch.selectedIndex].text;
         var ses = document.getElementById("session").value; 
