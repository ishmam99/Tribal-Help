            ...
            <div class="card p-5">
                <div class="row">
                    ...
                    <div class="col-8 text-center">
                        ...
                        <h3>বয়স ভিত্তিক ঝুঁকিপূর্ণ স্বাস্থ্য সমস্যা শনাক্তকরণ রিপোর্ট</h3>
                    </div>
                    ...
                    <script type="text/javascript">
                       ...
                       { calc: "stringify",
                         ...
                         role: "annotation" } ]);
                            var options = {
                                title : 'বয়স ভিত্তিক ঝুঁকিপূর্ণ স্বাস্থ্য সমস্যা শনাক্তকরণ চার্ট (শতকরা হিসেবে)',
                                bar: {groupWidth: "80%"},
                               width: 870,
                                legend: 'none',
                                pointSize: 6
