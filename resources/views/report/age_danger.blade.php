...
<div class="main-content">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">বয়স ভিত্তিক ঝুঁকিপূর্ণ স্বাস্থ্য সমস্যা সনাক্তকরণ
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container">
            <div class="card col-12">
                <div class="p-5 m-5 text-center">
                    <div class="col-8 mb-5">
                        <form action="{{ route('ageDanger.report') }}" method="post">
                            @csrf
          ...
          <input type="text" required class="form-control" name="year" autocomplete="off" placeholder="ক্যালেন্ডার বর্ষ" id="datepicker" />
                            ...
                            <select name="age" class="form-control" id="upazila" required>
                                <option value="" selected>--বয়স নির্বাচন করুন--</option>
                                @for ($i = 4 ; $i<=18;$i++)
                                    <option value="{{ $i }}">{{ en2bn($i) }}</option>
                                @endfor
                            </select>
