...
<body>
  ...
  <table id="maintable"  >
    ...
    <tr>
      ...
      <td width="60%" style="text-align:center;">
        @if($dateS==$dateE)
        <p style="font-size: 20px;">{{ bn2enNumber($dateS)}} তারিখের আবেদনের তালিকা রিপোর্ট</p>
        @else
        <p style="font-size: 20px;">{{ bn2enNumber($dateS)}} থেকে {{ bn2enNumber($dateE)}} তারিখ পর্যন্ত আবেদনের তালিকা রিপোর্ট</p>
        @endif
      </td> 
