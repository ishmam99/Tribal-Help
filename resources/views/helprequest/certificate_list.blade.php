        ...
        <div id="data-table" >
            <div class="card tabelanimate">
                <div class="card-header justify-content-center">
                    <h5 class="text-white">সনদপত্র আবেদনের তালিকা</h5>
                </div>
                <div class="card-body">
                       ...
                       <table id="example"  class="table table-striped table-bordered display"  style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th class="nosort">ছবি</th>

                                    <th class="nosort">নাগরিকত্ব সনদ</th>
                                    <th class="nosort">প্রত্যয়ন পত্র</th>
                                    <th class="nosort">প্রশংসাপত্র </th>
                                    <th class="nosort">এন আই ডি</th> --}}
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($applications as $application)
                                    <tr>
                                        ...
                                        <td>@if($application->status == 0 )
                                             <span class="text-warning">অপেক্ষমাণ </span>@else
                                             <span class="text-primary"> প্রক্রিয়াধীন</span>
                                            @endif</td>
                                         <td>{{toBangla(Carbon\Carbon::parse($application->updated_at)->format('d/m/y'))}}</td>
                                         <td >

                                           <a href="{{route('application.pdf',$application->id)}}" style="font-size: 10px">ফরম</a><br>
                                            <a href="{{setImage($application->files->where('type',1)->first()->file)}}" style="font-size: 10px">ছবি </a><br>
                                            <a href="{{setImage($application->files->where('type',2)->first()->file)}}" style="font-size: 10px">নাগরিকত্ব সনদ</a><br>
                                            <a href="{{setImage($application->files->where('type',3)->first()->file)}}" style="font-size: 10px">প্রত্যয়ন পত্র </a><br>
                                            <a href="{{setImage($application->files->where('type',4)->first()->file)}}" style="font-size: 10px">প্রশংসাপত্র </a><br>
                                            <a href="{{setImage($application->files->where('type',5)->first()->file)}}" style="font-size: 10px">এন আই ডি </a>
