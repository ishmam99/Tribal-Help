  ...
  ?>
   <table id="maintable"  >
    <tr>
      ...
      <td width="60%" style="text-align:center;">
        ...
        <h4 style="font-size: 25px;">ক্ষুদ্র নৃ-গোষ্ঠী সেবা কর্ণার
    ...
    <tr>
      ...
      <td width="20%" style="text-align:right;">
        <p>তারিখ : {{bn2enNumber(now()->format('d/m/y')) }} </p>
      </td>
    </tr>
  </table>
   ...
   <br>
         ...
         <table  id="maintable2" >
          <TBODY>
            <tr>
               <td width="25%"><p  style="font-weight: bold;">আবেদন আইডি</p></td><td><p>:</p></td><td colspan="2" ><p>{{bn2enNumber($id)}}</p></td>
            </tr>
            <tr>
               <td  width="25%"><p  style="font-weight: bold;">আবেদনের তারিখ</p></td><td><p>:</p></td><td colspan="2" ><p>{{bn2enNumber(Carbon\Carbon::parse(($helprequest->created_at))->format('d/m/y'))}}</p></td>
            </tr>
            <tr>
               <td  width="25%"><p  style="font-weight: bold;">আবেদনের বিষয়</p></td><td><p>:</p></td><td colspan="2" ><p>{{$helprequest->application_subject}}</p></td>
            </tr>

            <tr>
               <td  width="25%"><p  style="font-weight: bold;">আবেদনের ধরণ</p></td><td><p>:</p></td><td colspan="2" ><p>{{$helprequest->subject->name}}</p></td>
            </tr>
            <tr>
               <td  width="25%"><p  style="font-weight: bold;">ফোকাল পয়েন্ট</p></td><td><p>:</p></td><td colspan="2" ><p>{{$helprequest->user->name}}</p></td>
            </tr>
            <tr>
            ...
            <td style="text-align: center;padding: 90px 0px 0px 5px;" >
                ...
                <p>স্বাক্ষর</p><p>-<br>ক্ষুদ্র নৃ-গোষ্ঠী সেবা কর্ণার</p>
