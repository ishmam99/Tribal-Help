                    ...
                    <div id="data-table" class="animated fadeIn delay-1s ">
                        <div class="main-card mb-3 card">
                            <div class="card-header justify-content-center">
                                <h5 class="text-white">ব্যবহারকারী হালনাগাদ ফর্ম</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" value="{{$user->name}}" placeholder="নাম" class="form-control @error('name') is-invalid @enderror"
                                                name="name"  type="text">
                                            @error('name')
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username" value="{{$user->username}}" placeholder="ইউজারনেইম"
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="email" placeholder="ই-মেইল" value="{{$user->email}}" class="form-control @error('email') is-invalid @enderror"
                  ...
                  @enderror
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="mobile" placeholder="মোবাইল" value="{{$user->mobile}}" class="form-control @error('mobile') is-invalid @enderror" type="text" name="mobile">
                  @error('mobile')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="position" style="color:#312e2e" placeholder="পদবি"
                                                ...
                                                <option value="UNO" {{$user->position == 'UNO'  ? 'selected':'' }}>ইউএনও</option>
                                                <option value="ADC" {{$user->position == 'ADC'  ? 'selected':'' }}>এডিসি</option>
                                                <option value="DC-OFFICE" {{$user->position == 'DC-OFFICE'  ? 'selected':'' }}>ডিসি-অফিস</option>
                                                <option value="AC" {{$user->position == 'AC'  ? 'selected':'' }}>এসি-ল্যান্ড</option>
                                                <option value="STUFF" {{$user->position == 'STUFF'  ? 'selected':'' }}>কর্মচারী</option>
                                            </select>
                  ...
                  @enderror
                                     ...
                                     <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <img src="{{setImage($user->profile_image,'user')}}" height="150" width="150" alt="">
